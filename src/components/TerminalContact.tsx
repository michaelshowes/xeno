  ...
  return (
    ...
    >
      <div
        ...
        className='h-96 bg-slate-950/70 backdrop-blur rounded-lg w-full max-w-3xl shadow-xl cursor-text overflow-hidden font-mono'
      >
        <TerminalHeader />
        <TerminalBody
          inputRef={inputRef}
